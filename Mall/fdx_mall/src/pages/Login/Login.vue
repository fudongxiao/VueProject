    ...
    <div class="login-inner">
      ...
      <div class="login-header">
        <div class="login-logo">
          <img src="./images/logos.png" alt width="250">
        </div>
        <!--面板标题-->
...
import { getSmsCode, phoneLoginCode, pwdLogin } from "./../../api/index.js";
export default {
  name: "Login",
  data() {
    return {
  ...
  methods: {
    ...
    async getVerifyCode() {
      ...
      console.log("短信验证码 " + result.message);
      Toast({message:result.message,duration: 3000});
      // 2.3 获取验证码失败
    ...
    async login() {
      ...
      if (this.loginMode) {//验证码登录
        ...
        //5.3手机验证码登录
        const result = await phoneLoginCode(this.phone, this.code);
        // console.log(result);
      ...
      .login-header-title {
        ...
        > a {
          ...
          &.current {
            color: #6f8397;
            font-weight: 700;
            border-bottom: 2px solid #6f8397;
          }
        }
      }
    }
